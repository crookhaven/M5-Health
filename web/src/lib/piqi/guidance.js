...
export const PATIENT_FIXABLE_FIELDS = new Set([
  ...
  'procedureDateTime',
  'procedureStatus',
  // Added for the International Patient Summary (IPS) rubric, which checks
  // these on demographics, allergies, medications and conditions.
  'doseAmountUnit',
  'clinicalStatus',
  'primaryLanguage',
  'telecom',
...
export const FIELD_GUIDANCE = {
  ...
  doseAmountUnit: {
    explanation: 'The record has no unit for the dose (for example mg or mL).',
    nextStep: 'Check your pill bottle or pharmacy label and enter the unit (for example, mg).',
  },
  clinicalStatus: {
    explanation: 'The record does not say whether this is still active or has resolved.',
    nextStep: 'Enter what you know (for example, Active or Resolved). If you are not sure, flag it for your provider.',
  },
  primaryLanguage: {
    explanation: 'Your preferred language is missing. Providers use it to arrange interpreters and translated materials.',
    nextStep: 'Enter the language you prefer for health care (for example, English).',
  },
  telecom: {
    explanation: 'No phone number is on file, so a provider cannot reach you from this record.',
    nextStep: 'Enter the best phone number to reach you.',
  },
  currentAddress: {
    explanation: 'No address is on file.',
    nextStep: 'Enter your current mailing address.',
  },
  onsetDate: {
    explanation: 'The record does not say when this condition started.',
    nextStep: 'Enter the date or year if you know it. An approximate date is better than none.',
  },
  effectiveDate: {
    explanation: 'The record does not say when this allergy was first noted.',
    nextStep: 'Enter the date or year if you know it.',
  },
  startDate: {
    explanation: 'The record does not say when you started this medicine.',
    nextStep: 'Enter the start date if you know it. Your pharmacy can help.',
  },
}
